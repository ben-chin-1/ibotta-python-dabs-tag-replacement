...
The 'dabs_python_example' project was generated by using the "Jobs as code" template.
...
2. To deploy the bundle to the development target:
   ...
   *(Note that "dev" is the default target, so the `--target` parameter is optional here.)*
   ...
   `[dev yourname] dabs_python_example_job` to your workspace.
...
3. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/dabs_python_example_job.py). The schedule
